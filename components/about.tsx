        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6">
            ...
            {/* <p className="text-lg text-foreground/70 leading-relaxed">
              ...
              and I'm dedicated to delivering high-impact solutions that create
              meaningful value.
            </p>

            <p className="text-lg text-foreground/70 leading-relaxed">
              Beyond coding, I'm fascinated by emerging technologies,
              architectural patterns, and the intersection of design and
