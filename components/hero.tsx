    ...
    <section className="min-h-screen bg-background flex items-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full opacity-20" 
             style={{background: 'radial-gradient(circle, oklch(0.6 0.22 29) 0%, transparent 70%)'}}></div>
      </div>
      ...
      <div className="relative w-full max-w-6xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-8 z-10">
          <div className="space-y-4">
            <p className="text-accent text-sm font-semibold uppercase tracking-widest">TypeScript Developer</p>
            <h1 className="text-5xl lg:text-6xl font-bold text-foreground leading-tight text-pretty">
              Full-Stack Developer
            </h1>
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              Crafting scalable, secure, and high-performance web systems using TypeScript, React, and Node.js. Passionate about clean architecture and delivering end-to-end solutions.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button className="px-8 py-3 border border-accent text-accent font-semibold rounded-full hover:bg-accent/10 transition-colors">
              View work
            </button>
          </div>
